...
// TestBroadcastEncodeForSigning tests the MsgBroadcast
// wire.EncodeForEncryption and DecodeForEncryption for various versions.
...
func TestBroadcastencodeForSigningError(t *testing.T) {
	...
	_, tstTagged := TstNewBroadcast(t, 83928, expires, 1, tag, enc, 3, 1, 1, pubKey1, pubKey2,
		pow.Data{1024, 1024},
		1, m, a, nil)

...
func TestCalcHash(t *testing.T) {
	for _, pair := range addressTests {
		...
		// TODO
		V4BroadcastDecryptionKey(addr)
		V5BroadcastDecryptionKey(addr)
		Tag(addr)
	}
}
